...
Closure: {
	'C++': {
		'samples-cpp-module-dynamic-library-application': { Version: './', Build: '0', Tool: '0' }
		'samples-cpp-module-dynamic-library-library': { Version: '../library/', Build: '0', Tool: '0' }
	}
}
Builds: {
	'0': {
		Wren: {
			'soup|cpp': {
				Version: 0.19.1
				Digest: 'sha256:8898c65c63ca4629280673719123bf8a956a8d06e53028209dbaf0c382c4c322'
				Artifacts: {
					Linux: 'sha256:04e48b24e2ba9c584b85daad9b7f8eba5cd510c1cb8f2dfd230b4934d4583ae5'
