...
namespace Monitor::Windows::Functions::Cache::WinBase {
	...
	/// <summary>
	/// Copies an existing file to a new file, notifying the application of its progress through a
	/// callback function.
	/// </summary>
	...
	/// executable file in the security context of the specified credentials (user, domain, and
	/// password). It can optionally load the user profile for a specified user.
	/// </summary>
	...
	BOOLEAN(WINAPI *CreateSymbolicLinkA)(
		LPCSTR lpSymlinkFileName, LPCSTR lpTargetFileName, DWORD dwFlags) = ::CreateSymbolicLinkA;
	BOOLEAN(WINAPI *CreateSymbolicLinkW)(
		LPCWSTR lpSymlinkFileName, LPCWSTR lpTargetFileName, DWORD dwFlags) = ::CreateSymbolicLinkW;
	...
	/// </summary>
	BOOL(WINAPI *DecryptFileA)(LPCSTR lpFileName, DWORD dwReserved) = ::DecryptFileA;
	BOOL(WINAPI *DecryptFileW)(LPCWSTR lpFileName, DWORD dwReserved) = ::DecryptFileW;
	...
	/// </summary>
	BOOL(WINAPI *EncryptFileA)(LPCSTR lpFileName) = ::EncryptFileA;
	BOOL(WINAPI *EncryptFileW)(LPCWSTR lpFileName) = ::EncryptFileW;
	...
	/// operation. The function returns a handle to the enumeration that can be used on subsequent
	/// calls to the FindNextFileNameW function.
	/// </summary>
	...
	/// <summary>
	/// Searches a directory for a file or subdirectory with a name that matches a specific name as
	...
	/// <summary>
	/// Determines whether a file is an executable (.exe) file, and if so, which subsystem runs the
	/// executable file.
	/// </summary>
	BOOL(WINAPI *GetBinaryTypeA)(LPCSTR lpApplicationName, LPDWORD lpBinaryType) = ::GetBinaryTypeA;
	...
	/// application.
	/// </summary>
	DWORD(WINAPI *GetDllDirectoryA)(DWORD nBufferLength, LPSTR lpBuffer) = ::GetDllDirectoryA;
	DWORD(WINAPI *GetDllDirectoryW)(DWORD nBufferLength, LPWSTR lpBuffer) = ::GetDllDirectoryW;

	/// <summary>
	/// Retrieves the contents of the specified variable from the environment block of the calling
	/// process.
	/// </summary>
	...
	/// <summary>
	/// Retrieves the bandwidth reservation properties of the volume on which the specified file
	/// resides.
	/// </summary>
	...
	/// <summary>
	/// Obtains specified information about the security of a file or directory. The information
	...
	/// </summary>
	DWORD(WINAPI *LoadModule)(LPCSTR lpModuleName, LPVOID lpParameterBlock) = ::LoadModule;

	/// <summary>
	/// Loads the specified packaged module and its dependencies into the address space of the
	/// calling process.
	/// </summary>
	...
	/// </summary>
	BOOL(WINAPI *MoveFileA)(LPCSTR lpExistingFileName, LPCSTR lpNewFileName) = ::MoveFileA;
	BOOL(WINAPI *MoveFileW)(LPCWSTR lpExistingFileName, LPCWSTR lpNewFileName) = ::MoveFileW;
	...
	/// <summary>
	/// Moves a file or directory, including its children. You can provide a callback function that
	...
	/// </summary>
	HFILE(WINAPI *OpenFile)(LPCSTR lpFileName, LPOFSTRUCT lpReOpenBuff, UINT uStyle) = ::OpenFile;
	...
	/// <summary>
	/// Replaces one file with another file, with the option of creating a backup copy of the
	/// original file.
	/// </summary>
	...
	/// </summary>
	BOOL(WINAPI *SetCurrentDirectoryA)(LPCSTR lpPathName) = ::SetCurrentDirectoryA;
	BOOL(WINAPI *SetCurrentDirectoryW)(LPCWSTR lpPathName) = ::SetCurrentDirectoryW;

	/// <summary>
	/// Adds a directory to the search path used to locate DLLs for the application.
	/// </summary>
	BOOL(WINAPI *SetDllDirectoryA)(LPCSTR lpPathName) = ::SetDllDirectoryA;
	BOOL(WINAPI *SetDllDirectoryW)(LPCWSTR lpPathName) = ::SetDllDirectoryW;
	...
	/// is specified as a number of bytes in a period of milliseconds for I/O requests on the
	...
	/// <summary>
	/// Sets the notification modes for a file handle, allowing you to specify how completion
	/// notifications work for the specified file.
	/// </summary>
	...
	/// </summary>
	BOOL(WINAPI *SetFileShortNameA)(HANDLE hFile, LPCSTR lpShortName) = ::SetFileShortNameA;
	BOOL(WINAPI *SetFileShortNameW)(HANDLE hFile, LPCWSTR lpShortName) = ::SetFileShortNameW;

	/// <summary>
	/// Sets the per-process mode that the SearchPath function uses when locating files.
	/// </summary>
	BOOL(WINAPI *SetSearchPathMode)(DWORD Flags) = ::SetSearchPathMode;
