...
namespace Monitor::Windows::Functions::Cache::FileApi {
	...
	/// </summary>
	BOOL(WINAPI *DeleteFileA)(LPCSTR lpFileName) = ::DeleteFileA;
	BOOL(WINAPI *DeleteFileW)(LPCWSTR lpFileName) = ::DeleteFileW;

	/// <summary>
	/// Deletes a drive letter or mounted folder.
	/// </summary>
	BOOL(WINAPI *DeleteVolumeMountPointW)(LPCWSTR lpszVolumeMountPoint) = ::DeleteVolumeMountPointW;
	...
	/// </summary>
	BOOL(WINAPI *FindClose)(HANDLE hFindFile) = ::FindClose;

	/// <summary>
	/// Stops change notification handle monitoring.
	/// </summary>
	BOOL(WINAPI *FindCloseChangeNotification)(HANDLE hChangeHandle) = ::FindCloseChangeNotification;

	/// <summary>
	/// Creates a change notification handle and sets up initial change notification filter
	/// conditions.
	/// </summary>
	...
	HANDLE(WINAPI *FindFirstChangeNotificationW)(LPCWSTR lpPathName, BOOL bWatchSubtree, DWORD) =
	...
	/// <summary>
	/// Creates an enumeration of all the hard links to the specified file. The FindFirstFileNameW
	...
	/// <summary>
	/// Requests that the operating system signal a change notification handle the next time it
	/// detects an appropriate change.
	/// </summary>
	BOOL(WINAPI *FindNextChangeNotification)(HANDLE hChangeHandle) = ::FindNextChangeNotification;
	...
	/// <summary>
	/// Continues enumerating the hard links to a file using the handle returned by a successful
	/// call to the FindFirstFileNameW function.
	/// </summary>
	BOOL(WINAPI *FindNextFileNameW)(HANDLE hFindStream, LPDWORD StringLength, PWSTR LinkName) =
		::FindNextFileNameW;

	/// <summary>
	/// Continues a stream search started by a previous call to the FindFirstStreamW function.
	/// </summary>
	BOOL(WINAPI *FindNextStreamW)(HANDLE hFindStream, LPVOID lpFindStreamData) = ::FindNextStreamW;

	/// <summary>
	/// Continues a volume search started by a call to the FindFirstVolume function.
	/// </summary>
	BOOL(WINAPI *FindNextVolumeW)(
		HANDLE hFindVolume, LPWSTR lpszVolumeName, DWORD cchBufferLength) = ::FindNextVolumeW;

	/// <summary>
	/// Closes the specified volume search handle.
	/// </summary>
	BOOL(WINAPI *FindVolumeClose)(HANDLE hFindVolume) = ::FindVolumeClose;

	/// <summary>
	/// Flushes the buffers of a specified file and causes all buffered data to be written to a
	/// file.
	/// </summary>
	BOOL(WINAPI *FlushFileBuffers)(HANDLE hFile) = ::FlushFileBuffers;
	...
	/// the total amount of space, the total amount of free space, and the total amount of free
	...
	/// </summary>
	UINT(WINAPI *GetDriveTypeA)(LPCSTR lpRootPathName) = ::GetDriveTypeA;
	UINT(WINAPI *GetDriveTypeW)(LPCWSTR lpRootPathName) = ::GetDriveTypeW;

	/// <summary>
	/// Retrieves file system attributes for a specified file or directory.
	/// </summary>
	DWORD(WINAPI *GetFileAttributesA)(LPCSTR lpFileName) = ::GetFileAttributesA;
	DWORD(WINAPI *GetFileAttributesW)(LPCWSTR lpFileName) = ::GetFileAttributesW;
	...
	/// </summary>
	DWORD(WINAPI *GetFileSize)(HANDLE hFile, LPDWORD lpFileSizeHigh) = ::GetFileSize;

	/// <summary>
	/// Retrieves the size of the specified file.
	/// </summary>
	BOOL(WINAPI *GetFileSizeEx)(HANDLE hFile, PLARGE_INTEGER lpFileSize) = ::GetFileSizeEx;
	...
	/// </summary>
	DWORD(WINAPI *GetFileType)(HANDLE hFile) = ::GetFileType;
	...
	/// </summary>
	DWORD(WINAPI *GetTempPathA)(DWORD nBufferLength, LPSTR lpBuffer) = ::GetTempPathA;
	DWORD(WINAPI *GetTempPathW)(DWORD nBufferLength, LPWSTR lpBuffer) = ::GetTempPathW;
	...
	/// <summary>
	/// Retrieves a volume GUID path for the volume that is associated with the specified volume
	...
	/// <summary>
	/// Locks the specified file for exclusive access by the calling process. This function can
	/// operate either synchronously or asynchronously and can request either an exclusive or a
	/// shared lock.
	/// </summary>
	...
	/// </summary>
	BOOL(WINAPI *RemoveDirectoryA)(LPCSTR lpPathName) = ::RemoveDirectoryA;
	BOOL(WINAPI *RemoveDirectoryW)(LPCWSTR lpPathName) = ::RemoveDirectoryW;

	/// <summary>
	/// Sets the physical file size for the specified file to the current position of the file
	/// pointer.
	/// </summary>
	BOOL(WINAPI *SetEndOfFile)(HANDLE hFile) = ::SetEndOfFile;
	...
	BOOL(WINAPI *SetFileIoOverlappedRange)(
		HANDLE FileHandle, PUCHAR OverlappedRangeStart, ULONG Length) = ::SetFileIoOverlappedRange;
	...
	/// <summary>
	/// Sets the date and time that the specified file or directory was created, last accessed, or
	/// last modified.
	/// </summary>
	...
	/// <summary>
	/// Sets the valid data length of the specified file. This function is useful in very limited
	/// scenarios. For more information, see the Remarks section.
	/// </summary>
	BOOL(WINAPI *SetFileValidData)(HANDLE hFile, LONGLONG ValidDataLength) = ::SetFileValidData;
