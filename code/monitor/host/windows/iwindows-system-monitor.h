...
namespace Monitor::Windows {
	...
	public:
		...
		virtual void OnCreateDirectoryA(
			std::string_view pathName, bool result, bool wasBlocked) = 0;
		virtual void OnCreateDirectoryW(
			std::wstring_view pathName, bool result, bool wasBlocked) = 0;
		...
		virtual void OnFindFirstChangeNotificationA(
			std::string_view pathName, bool watchSubtree, uint32_t notifyFilter) = 0;
		virtual void OnFindFirstChangeNotificationW(
			std::wstring_view pathName, bool watchSubtree, uint32_t notifyFilter) = 0;
		...
		virtual void OnGetFileAttributesA(
			std::string_view fileName, uint32_t result, bool wasBlocked) = 0;
		virtual void OnGetFileAttributesW(
			std::wstring_view fileName, uint32_t result, bool wasBlocked) = 0;
		virtual void OnGetFileAttributesExA(
			std::string_view fileName, bool result, bool wasBlocked) = 0;
		virtual void OnGetFileAttributesExW(
			std::wstring_view fileName, bool result, bool wasBlocked) = 0;
		...
		virtual void OnGetFullPathNameW(
			std::wstring_view fileName, std::wstring_view buffer, uint32_t result) = 0;
		...
		virtual void OnGetLongPathNameA(
			std::string_view shortPath, std::string_view longPath, uint32_t result) = 0;
		virtual void OnGetLongPathNameW(
			std::wstring_view shortPath, std::wstring_view longPath, uint32_t result) = 0;
		virtual void OnGetShortPathNameW(
			std::wstring_view longPath, std::wstring_view shortPath, uint32_t result) = 0;
		...
		virtual void OnCreateProcessA(
			bool wasDetoured, std::string_view applicationName, bool result) = 0;
		virtual void OnCreateProcessW(
			bool wasDetoured, std::wstring_view applicationName, bool result) = 0;
		...
		virtual void OnCreateHardLinkA(
			std::string_view fileName, std::string_view existingFileName, bool result) = 0;
		virtual void OnCreateHardLinkW(
			std::wstring_view fileName, std::wstring_view existingFileName, bool result) = 0;
		...
		virtual void OnGetCompressedFileSizeTransactedA(
			std::string_view fileName, uint32_t result) = 0;
		virtual void OnGetCompressedFileSizeTransactedW(
			std::wstring_view fileName, uint32_t result) = 0;
		...
		virtual void OnGetShortPathNameA(
			std::string_view longPath, std::string_view shortPath, uint32_t result) = 0;
		...
		virtual void OnOpenEncryptedFileRawA(
			std::string_view fileName, uint32_t flags, uint32_t result) = 0;
		virtual void OnOpenEncryptedFileRawW(
			std::wstring_view fileName, uint32_t flags, uint32_t result) = 0;
		...
		virtual void OnSetFileAttributesTransactedA(
			std::string_view pathName, uint32_t fileAttributes, bool result, bool wasBlocked) = 0;
		virtual void OnSetFileAttributesTransactedW(
			std::wstring_view pathName, uint32_t fileAttributes, bool result, bool wasBlocked) = 0;
