...
namespace Monitor::Linux {
	...
	public:
		...
		virtual void OnMkdirAt(
			int32_t dirfd, std::string_view path, uint32_t mode, int32_t result) = 0;
		virtual void OnOpen(std::string_view path, int32_t oflag, int32_t result) = 0;
		virtual void OnOpenAt(
			int32_t dirfd, std::string_view pathname, int32_t flags, int32_t result) = 0;
		virtual void OnOpenAt2(
			int32_t dirfd, std::string_view pathname, int32_t flags, int32_t result) = 0;
		virtual void OnRemove(std::string_view pathname, int32_t result) = 0;
		virtual void OnRename(
			std::string_view oldpath, std::string_view newpath, int32_t result) = 0;
		virtual void OnRenameAt(
			int32_t oldfd,
			std::string_view oldpath,
			int32_t newfd,
			std::string_view newpath,
			int32_t result) = 0;
		virtual void OnRenameAt2(
			int32_t oldfd,
			std::string_view oldpath,
			int32_t newfd,
			std::string_view newpath,
