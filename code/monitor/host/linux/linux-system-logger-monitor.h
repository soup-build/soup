#pragma once
#include "ilinux-system-monitor.h"
...
namespace Monitor::Linux {
	...
	public:
		...
		void OnLinkAt(
			...
			m_stream << "linkat(" << olddirfd << ", " << oldpath << ", " << newdirfd << ", "
					 << newpath << ", " << flags << ") = " << result << std::endl;
		}
		...
		void OnMkdirAt(
			int32_t dirfd, std::string_view path, uint32_t mode, int32_t result) override final {
			m_stream << "mkdirat(" << dirfd << ", " << path << ", " << mode << ") = " << result
					 << std::endl;
		}
		...
		void OnOpenAt(int32_t dirfd, std::string_view pathname, int32_t flags, int32_t result)
			override final {
			m_stream << "openat(" << dirfd << ", " << pathname << ", " << flags << ") = " << result
					 << std::endl;
		}

		void OnOpenAt2(int32_t dirfd, std::string_view pathname, int32_t flags, int32_t result)
			override final {
			m_stream << "openat2(" << dirfd << ", " << pathname << ", " << flags << ") = " << result
					 << std::endl;
		}
		...
		void OnRenameAt(
			...
			std::string_view newpath,
			int32_t result) override final {
			m_stream << "renameat(" << oldfd << ", " << oldpath << ", " << newfd << ", " << newpath
					 << ") = " << result << std::endl;
		}
		...
		void OnRenameAt2(
			...
			std::string_view newpath,
			int32_t result) override final {
			m_stream << "renameat2(" << oldfd << ", " << oldpath << ", " << newfd << ", " << newpath
					 << ") = " << result << std::endl;
		}
