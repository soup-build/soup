...
int main() {
...

	{
		...
		auto content = std::stringstream(
			std::string(
				reinterpret_cast<char *>(binaryFileContent.data()), binaryFileContent.size()));
	...
	{
		auto binaryFileContent = std::vector<unsigned char>({
			'B',  'V',	'T',  '\0', 0x02, 0x00, 0x00, 0x00, 'T',  'B',	'L',  '\0', 0x08, 0x00,
			0x00, 0x00, 0x0b, 0x00, 0x00, 0x00, 'T',  'e',	's',  't',	'B',  'o',	'o',  'l',
			'e',  'a',	'n',  0x6,	0x0,  0x0,	0x0,  0x1,	0x00, 0x00, 0x00, 0x0d, 0x00, 0x00,
			0x00, 'T',	'e',  's',	't',  'D',	'e',  'e',	'p',  'T',	'a',  'b',	'l',  'e',
			0x1,  0x0,	0x0,  0x0,	0x1,  0x0,	0x0,  0x0,	0x6,  0x0,	0x0,  0x0,	'V',  'a',
			'l',  'u',	'e',  '1',	0x1,  0x0,	0x0,  0x0,	0x1,  0x0,	0x0,  0x0,	0x6,  0x0,
			0x0,  0x0,	'V',  'a',	'l',  'u',	'e',  '2',	0x1,  0x0,	0x0,  0x0,	0x1,  0x0,
			0x0,  0x0,	0x6,  0x0,	0x0,  0x0,	'V',  'a',	'l',  'u',	'e',  '3',	0x1,  0x0,
			0x0,  0x0,	0x1,  0x0,	0x0,  0x0,	0x6,  0x0,	0x0,  0x0,	'V',  'a',	'l',  'u',
			'e',  '4',	0x1,  0x0,	0x0,  0x0,	0x0,  0x0,	0x0,  0x0,	0x0d, 0x00, 0x00, 0x00,
			'T',  'e',	's',  't',	'E',  'm',	'p',  't',	'y',  'L',	'i',  's',	't',  0x2,
			0x0,  0x0,	0x0,  0x0,	0x0,  0x0,	0x0,  0x0e, 0x00, 0x00, 0x00, 'T',	'e',  's',
			't',  'E',	'm',  'p',	't',  'y',	'T',  'a',	'b',  'l',	'e',  0x1,	0x0,  0x0,
			0x0,  0x0,	0x0,  0x0,	0x0,  0x09, 0x00, 0x00, 0x00, 'T',	'e',  's',	't',  'F',
			'l',  'o',	'a',  't',	0x5,  0x0,	0x0,  0x0,	0xae, 0x47, 0xe1, 0x7a, 0x14, 0xae,
			0xf3, 0x3f, 0x0b, 0x00, 0x00, 0x00, 'T',  'e',	's',  't',	'I',  'n',	't',  'e',
			'g',  'e',	'r',  0x4,	0x0,  0x0,	0x0,  0x85, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
			0xff, 0x0f, 0x00, 0x00, 0x00, 'T',	'e',  's',	't',  'I',	'n',  't',	'e',  'g',
			'e',  'r',	'L',  'i',	's',  't',	0x2,  0x0,	0x0,  0x0,	0xa,  0x0,	0x0,  0x0,
			0x4,  0x0,	0x0,  0x0,	0x1,  0x0,	0x0,  0x0,	0x0,  0x0,	0x0,  0x0,	0x4,  0x0,
			0x0,  0x0,	0x2,  0x0,	0x0,  0x0,	0x0,  0x0,	0x0,  0x0,	0x4,  0x0,	0x0,  0x0,
			0x3,  0x0,	0x0,  0x0,	0x0,  0x0,	0x0,  0x0,	0x4,  0x0,	0x0,  0x0,	0x4,  0x0,
			0x0,  0x0,	0x0,  0x0,	0x0,  0x0,	0x4,  0x0,	0x0,  0x0,	0x5,  0x0,	0x0,  0x0,
			0x0,  0x0,	0x0,  0x0,	0x4,  0x0,	0x0,  0x0,	0x6,  0x0,	0x0,  0x0,	0x0,  0x0,
			0x0,  0x0,	0x4,  0x0,	0x0,  0x0,	0x7,  0x0,	0x0,  0x0,	0x0,  0x0,	0x0,  0x0,
			0x4,  0x0,	0x0,  0x0,	0x8,  0x0,	0x0,  0x0,	0x0,  0x0,	0x0,  0x0,	0x4,  0x0,
			0x0,  0x0,	0x9,  0x0,	0x0,  0x0,	0x0,  0x0,	0x0,  0x0,	0x4,  0x0,	0x0,  0x0,
			0xa,  0x0,	0x0,  0x0,	0x0,  0x0,	0x0,  0x0,	0x0a, 0x00, 0x00, 0x00, 'T',  'e',
			's',  't',	'S',  't',	'r',  'i',	'n',  'g',	0x3,  0x0,	0x0,  0x0,	0x5,  0x0,
			0x0,  0x0,	'V',  'a',	'l',  'u',	'e',
		});
		auto content = std::stringstream(
			std::string(
...

	{
		...
		auto binaryFileContent = std::vector<char>({
			'B',  'O',	'R',  '\0', 0x03, 0x00, 0x00, 0x00, 'F',  'I',	'S',  '\0',
			0x00, 0x00, 0x00, 0x00, 'R',  'T',	'S',  '\0', 0x00, 0x00, 0x00, 0x00,
		});
		auto content =
			std::stringstream(std::string(binaryFileContent.data(), binaryFileContent.size()));
...

	{
		...
		auto binaryFileContent = std::vector<uint8_t>({
			'B',  'O',	'R',  '\0', 0x00, 0x00, 0x00, 0x00, 'F',  'I',	'S',  '\0', 0x08, 0x00,
			0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 'C',  ':',	'/',  'F',
			'i',  'l',	'e',  '1',	0x02, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 'C',  ':',
			'/',  'F',	'i',  'l',	'e',  '2',	0x03, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00,
			'C',  ':',	'/',  'F',	'i',  'l',	'e',  '3',	0x04, 0x00, 0x00, 0x00, 0x08, 0x00,
			0x00, 0x00, 'C',  ':',	'/',  'F',	'i',  'l',	'e',  '4',	0x05, 0x00, 0x00, 0x00,
			0x08, 0x00, 0x00, 0x00, 'C',  ':',	'/',  'F',	'i',  'l',	'e',  '5',	0x06, 0x00,
			0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 'C',  ':',	'/',  'F',	'i',  'l',	'e',  '6',
			0x07, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 'C',  ':',	'/',  'F',	'i',  'l',
			'e',  '7',	0x08, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 'C',  ':',	'/',  'F',
			'i',  'l',	'e',  '8',	'R',  'T',	'S',  '\0', 0x02, 0x00, 0x00, 0x00, 0x05, 0x00,
			0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x10, 0x16, 0x62, 0xbb, 0x0b, 0x41, 0x38, 0x00,
			0x02, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x02, 0x00,
			0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x06, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x80, 0x8d, 0xa9, 0xeb, 0x0b, 0x41,
			0x38, 0x00, 0x02, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x07, 0x00, 0x00, 0x00,
			0x02, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00,
		});
		auto content = std::stringstream(
...

	{
		...
		fileSystem->CreateMockFile(
			Path("C:/testlocation/soup-generate.exe"), std::make_shared<MockFile>());
		...
		OperationGraphWriter::Serialize(
			soupCppOperationGraph, soupCppFiles, fileSystemState, soupCppOperationGraphContent);
		fileSystem->CreateMockFile(
			Path(
				"C:/Users/Me/.soup/packages/Wren/soup/cpp/0.8.2/out/"
		...
		auto soupCppGenerateInput = ValueTable(
			{
				...
				{"PackageRoot", std::string("C:/Users/Me/.soup/packages/Wren/soup/cpp/0.8.2/")},
								   ...
								   ValueTable(
									   {
										   {"SoupTargetDirectory",
											std::string(
												"C:/Users/Me/.soup/packages/Wren/soup/"
												"cpp/0.8.2/out/"
												"tsWW3RZ_9Jb7Xbk2kTzx3n6uQUM/.soup/")},
									   })},
							  })},
		...
		OperationResultsWriter::Serialize(
			...
			soupCppGenerateResultsFiles,
			fileSystemState,
			soupCppGenerateResultsContent);
		fileSystem->CreateMockFile(
			Path(
				"C:/Users/Me/.soup/packages/Wren/soup/cpp/0.8.2/out/"
		...
		OperationResultsWriter::Serialize(
			soupCppEvaluateResults,
			soupCppEvaluateResultsFiles,
			fileSystemState,
			soupCppEvaluateResultsContent);
		fileSystem->CreateMockFile(
			Path(
				"C:/Users/Me/.soup/packages/Wren/soup/cpp/0.8.2/out/"
		...
		OperationResultsWriter::Serialize(
			myPackageEvaluateResults,
			myPackageEvaluateResultsFiles,
			fileSystemState,
