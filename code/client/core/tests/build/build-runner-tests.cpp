	...
	public:
		...
		void Initialize_Success() {
			...
			auto packageProvider = PackageProvider(
				1, PackageGraphLookupMap(), PackageLookupMap(), PackageTargetDirectories());
		...
		void Execute_NoDependencies() {
			...
			auto generateResult = GenerateResult(
				OperationGraph(std::vector<OperationId>(), std::vector<OperationInfo>()), false);
			auto generateResultFiles = std::set<FileId>();
			auto generateResultContent = std::stringstream();
			GenerateResultWriter::Serialize(
				generateResult, generateResultFiles, fileSystemState, generateResultContent);
				...
				PackageLookupMap(
					{
						{1,
						 PackageInfo(
							 ...
							 &recipeCache.GetRecipe(
								 Path("C:/WorkingDirectory/my-package/recipe.sml")),
							 PackageChildrenMap())},
					}),
				PackageTargetDirectories(
					{{1, {{1, Path("C:/WorkingDirectory/my-package/out/HASH1/")}}}}));
			auto evaluateEngine = MockEvaluateEngine();
			auto uut = BuildRunner(
				arguments,
				userDataPath,
			...
			Assert::AreEqual(
				std::vector<std::string>({
					...
					"C:/WorkingDirectory/my-package/out/HASH1/.soup/generate-input.bvt",
			...
			Assert::AreEqual(
				std::vector<std::string>({
					...
					"TryOpenReadBinary: "
					"C:/WorkingDirectory/my-package/out/HASH1/.soup/generate-phase1.bgr",
					"TryOpenReadBinary: "
					"C:/WorkingDirectory/my-package/out/HASH1/.soup/evaluate-phase1.bor",
					...
					"C:/WorkingDirectory/my-package/out/HASH1/.soup/generate-input.bvt",
					"TryOpenReadBinary: "
					"C:/WorkingDirectory/my-package/out/HASH1/.soup/generate-phase1.bor",
					"OpenWriteBinary: "
					"C:/WorkingDirectory/my-package/out/HASH1/.soup/generate-phase1.bor",
					"TryOpenReadBinary: "
					"C:/WorkingDirectory/my-package/out/HASH1/.soup/generate-phase1.bgr",
				...
				ValueTable(
					{
						 ...
						 ValueTable(
							 {
								 ...
								 {"/(TARGET_my-package)/",
								  std::string("C:/WorkingDirectory/my-package/out/HASH1/")},
							 })},
						{"EvaluateReadAccess",
						 ValueList(
							 {
						...
						{"GenerateMacros", ValueTable()},
						{"GenerateSubGraphMacros", ValueTable()},
						{"GlobalState",
						 ValueTable(
							 {
								 {"Context",
			...
			Assert::AreEqual(
				OperationResults(
					{
						{1, OperationResult(true, GetEpochTime(), {}, {}, std::nullopt)},
					}),
		...
		void Execute_NoDependencies_HasPreprocessors() {
			...
			auto generateResultPhase1 = GenerateResult(
				OperationGraph(std::vector<OperationId>(), std::vector<OperationInfo>()), true);
			auto generateResultPhase1Files = std::set<FileId>();
			auto generateResultPhase1Content = std::stringstream();
			GenerateResultWriter::Serialize(
				generateResultPhase1,
				generateResultPhase1Files,
				fileSystemState,
				generateResultPhase1Content);
			fileSystem->CreateMockFile(
				Path("C:/WorkingDirectory/my-package/out/HASH1/.soup/generate-phase1.bgr"),
				std::make_shared<MockFile>(std::move(generateResultPhase1Content)));

			auto generateResultPhase2 =
				OperationGraph(std::vector<OperationId>(), std::vector<OperationInfo>());
			auto generateResultPhase2Files = std::set<FileId>();
			auto generateResultPhase2Content = std::stringstream();
			OperationGraphWriter::Serialize(
				generateResultPhase2,
				generateResultPhase2Files,
				fileSystemState,
				generateResultPhase2Content);
			fileSystem->CreateMockFile(
			...
			Assert::AreEqual(
				std::vector<std::string>({
					...
					"C:/WorkingDirectory/my-package/out/HASH1/.soup/evaluate-phase1.bor",
					"TryOpenReadBinary: "
					"C:/WorkingDirectory/my-package/out/HASH1/.soup/generate-phase2.bog",
					"TryOpenReadBinary: "
					"C:/WorkingDirectory/my-package/out/HASH1/.soup/evaluate-phase2.bor",
					"Exists: C:/WorkingDirectory/my-package/out/HASH1/.soup/",
					"CreateDirectory: C:/WorkingDirectory/my-package/out/HASH1/.soup/",
					"TryOpenReadBinary: "
					"C:/WorkingDirectory/my-package/out/HASH1/.soup/generate-input.bvt",
					...
					"C:/WorkingDirectory/my-package/out/HASH1/.soup/generate-input.bvt",
					"TryOpenReadBinary: "
					"C:/WorkingDirectory/my-package/out/HASH1/.soup/generate-phase2.bor",
					"OpenWriteBinary: "
					"C:/WorkingDirectory/my-package/out/HASH1/.soup/generate-phase2.bor",
					"TryOpenReadBinary: "
					"C:/WorkingDirectory/my-package/out/HASH1/.soup/generate-phase2.bog",
		...
		void Execute_BuildDependency() {
			...
			GenerateResultWriter::Serialize(
				myProjectGenerateResult,
				myProjectGenerateResultFiles,
				fileSystemState,
				myProjectGenerateResultContent);
			fileSystem->CreateMockFile(
				Path("C:/WorkingDirectory/my-package/out/HASH1/.soup/generate-phase1.bgr"),
			...
			GenerateResultWriter::Serialize(
				testBuildGenerateResult,
				testBuildGenerateResultFiles,
				fileSystemState,
				testBuildGenerateResultContent);
			fileSystem->CreateMockFile(
				Path(
					"C:/Users/Me/.soup/packages/C#/TestBuild/1.2.3/out/HASH2/.soup/"
					"generate-phase1.bgr"),
			...
			Assert::AreEqual(
				std::vector<std::string>({
					...
					"DIAG: "
					"2>C:/Users/Me/.soup/packages/C#/TestBuild/1.2.3/out/HASH2/.soup/"
					"generate-phase1.bgr",
					...
					"INFO: 2>Create Directory: "
					"C:/Users/Me/.soup/packages/C#/TestBuild/1.2.3/out/HASH2/temp/",
					"INFO: 2>Save operation results",
					"INFO: 2>Done!",
					"DIAG: 1>Running Build: [C++]my-package",
					"INFO: 1>Build 'my-package'",
			...
			Assert::AreEqual(
				std::vector<std::string>({
					...
					"C:/Users/Me/.soup/packages/C#/TestBuild/1.2.3/out/HASH2/",
					"TryOpenReadBinary: "
					"C:/Users/Me/.soup/packages/C#/TestBuild/1.2.3/out/HASH2/.soup/"
					"generate-phase1.bgr",
					"TryOpenReadBinary: "
			...
			// Verify files
			auto testBuildGenerateInputMockFile = fileSystem->GetMockFile(Path(
				"C:/Users/Me/.soup/packages/C#/TestBuild/1.2.3/out/HASH2/.soup/"
				"generate-input.bvt"));
			Assert::AreEqual(
				ValueTable(
			...
			auto testBuildGenerateResultsMockFile = fileSystem->GetMockFile(Path(
				"C:/Users/Me/.soup/packages/C#/TestBuild/1.2.3/out/HASH2/.soup/"
				"generate-phase1.bor"));
			auto testBuildGenerateResults = OperationResultsReader::Deserialize(
				testBuildGenerateResultsMockFile->Content, fileSystemState);
				...
				ValueTable(
					{
										   ...
										   ValueTable(
											   {
												   {"SoupTargetDirectory",
													std::string(
														"C:/Users/Me/.soup/packages/C#/TestBuild/"
														"1.2.3/out/HASH2/.soup/")},
											   })},
									  })},
							 })},
						{"EvaluateMacros",
						...
						{"GenerateSubGraphMacros",
						 ValueTable(
							 {
								 {"/(TARGET_user1|TestBuild)/",
								  std::string("/(BUILD_TARGET_user1|TestBuild)/")},
							 })},
						{"GlobalState",
						 ValueTable(
							 {
		...
		void Execute_TriangleDependency_NoRebuild() {
			...
			GenerateResultWriter::Serialize(
				packageAGenerateResult,
				packageAGenerateResultFiles,
				fileSystemState,
				packageAGenerateResultContent);
			fileSystem->CreateMockFile(
				Path(
					"C:/Users/Me/.soup/packages/C++/user1/package-a/1.2.3/out/HASH1/.soup/"
					"generate-phase1.bgr"),
			...
			GenerateResultWriter::Serialize(
				packageBGenerateResult,
				packageBGenerateResultFiles,
				fileSystemState,
				packageBGenerateResultContent);
			fileSystem->CreateMockFile(
				Path(
					"C:/Users/Me/.soup/packages/C++/user1/package-b/1.1.1/out/HASH1/.soup/"
					"generate-phase1.bgr"),
							  ...
							  RecipeTable(
								  {
									  {"Runtime",
									   RecipeList(
										   {"user1|package-a@1.2.3", "user1|package-b@1.1.1"})},
								  })},
						 }))},
				...
				PackageLookupMap(
					{
						...
						{2,
						 PackageInfo(
							 ...
							 &recipeCache.GetRecipe(Path(
								 "C:/Users/Me/.soup/packages/C++/user1/package-a/1.2.3/"
								 "recipe.sml")),
							 PackageChildrenMap(
								 {
									 {"Runtime",
						...
						{3,
						 PackageInfo(
							 ...
							 &recipeCache.GetRecipe(Path(
								 "C:/Users/Me/.soup/packages/C++/user1/package-b/1.1.1/"
								 "recipe.sml")),
							 PackageChildrenMap())},
					}),
				PackageTargetDirectories(
						...
						{1,
						 {
							 ...
							 {2,
							  Path(
								  "C:/Users/Me/.soup/packages/C++/user1/package-a/1.2.3/out/"
								  "HASH1/")},
							 {3,
							  Path(
								  "C:/Users/Me/.soup/packages/C++/user1/package-b/1.1.1/out/"
								  "HASH1/")},
						 }},
					}));
			auto evaluateEngine = MockEvaluateEngine();
			...
			Assert::AreEqual(
				std::vector<std::string>({
					...
					"DIAG: "
					"3>C:/Users/Me/.soup/packages/C++/user1/package-b/1.1.1/out/HASH1/.soup/"
					"generate-phase1.bgr",
					...
					"INFO: 3>Create Directory: "
					"C:/Users/Me/.soup/packages/C++/user1/package-b/1.1.1/out/HASH1/.soup/",
					"INFO: 3>Check outdated generate input file: "
					"C:/Users/Me/.soup/packages/C++/user1/package-b/1.1.1/out/HASH1/.soup/"
					"generate-input.bvt",
					...
					"INFO: 3>Create Directory: "
					"C:/Users/Me/.soup/packages/C++/user1/package-b/1.1.1/out/HASH1/temp/",
					"INFO: 3>Save operation results",
					"INFO: 3>Done!",
					...
					"INFO: 2>Checking for existing Generate Phase 1 Result",
					"DIAG: "
					"2>C:/Users/Me/.soup/packages/C++/user1/package-a/1.2.3/out/HASH1/.soup/"
					"generate-phase1.bgr",
					"INFO: 2>Phase1 previous graph found",
					"INFO: 2>Checking for existing Evaluate Operation Results",
					"DIAG: "
					...
					"DIAG: 2>Map previous operation graph observed results",
					"INFO: 2>Create Directory: "
					"C:/Users/Me/.soup/packages/C++/user1/package-a/1.2.3/out/HASH1/temp/",
					"INFO: 2>Save operation results",
					"INFO: 2>Done!",
					"DIAG: 3>Running Build: [C++]user1|package-b",
			...
			Assert::AreEqual(
				std::vector<std::string>({
					"TryGetDirectoryFilesLastWriteTime: "
					"C:/Users/Me/.soup/packages/C++/user1/package-b/1.1.1/out/HASH1/",
					"TryOpenReadBinary: "
					"C:/Users/Me/.soup/packages/C++/user1/package-b/1.1.1/out/HASH1/.soup/"
					"generate-phase1.bgr",
					"TryOpenReadBinary: "
					...
					"evaluate-phase1.bor",
					"TryGetDirectoryFilesLastWriteTime: "
					"C:/Users/Me/.soup/packages/C++/user1/package-a/1.2.3/out/HASH1/",
					"TryOpenReadBinary: "
					"C:/Users/Me/.soup/packages/C++/user1/package-a/1.2.3/out/HASH1/.soup/"
					"generate-phase1.bgr",
					"TryOpenReadBinary: "
			...
			// Verify files
			auto packageAGenerateInputMockFile = fileSystem->GetMockFile(Path(
				"C:/Users/Me/.soup/packages/C++/user1/package-a/1.2.3/out/HASH1/.soup/"
				"generate-input.bvt"));
			Assert::AreEqual(
				ValueTable(
										   ...
										   ValueTable(
											   {
												   {"SoupTargetDirectory",
													std::string(
														"C:/Users/Me/.soup/packages/C++/user1/"
														"package-b/1.1.1/out/HASH1/.soup/")},
											   })},
									  })},
							 })},
						{"EvaluateMacros",
						 ValueTable(
							 {
								 {"/(PACKAGE_user1|package-a)/",
								  std::string(
									  "C:/Users/Me/.soup/packages/C++/user1/package-a/1.2.3/")},
								 {"/(TARGET_user1|package-a)/",
								  std::string(
									  "C:/Users/Me/.soup/packages/C++/user1/package-a/1.2.3/out/"
									  "HASH1/")},
								 {"/(TARGET_user1|package-b)/",
								  std::string(
									  "C:/Users/Me/.soup/packages/C++/user1/package-b/1.1.1/out/"
									  "HASH1/")},
							 })},
															 ...
															 ValueTable(
																 {
																	 {"Reference",
																	  std::string(
																		  "user1|package-b@1.1.1")},
																	 {"TargetDirectory",
																	  std::string(
																		  "/(TARGET_user1|package-"
																		  "b)/")},
																 })},
														})},
											   })},
			...
			auto packageAGenerateResultsMockFile = fileSystem->GetMockFile(Path(
				"C:/Users/Me/.soup/packages/C++/user1/package-a/1.2.3/out/HASH1/.soup/"
				"generate-phase1.bor"));
			auto packageAGenerateResults = OperationResultsReader::Deserialize(
				packageAGenerateResultsMockFile->Content, fileSystemState);
			...
			auto packageBGenerateInputMockFile = fileSystem->GetMockFile(Path(
				"C:/Users/Me/.soup/packages/C++/user1/package-b/1.1.1/out/HASH1/.soup/"
				"generate-input.bvt"));
			Assert::AreEqual(
				ValueTable(
			...
			auto packageBGenerateResultsMockFile = fileSystem->GetMockFile(Path(
				"C:/Users/Me/.soup/packages/C++/user1/package-b/1.1.1/out/HASH1/.soup/"
				"generate-phase1.bor"));
			auto packageBGenerateResults = OperationResultsReader::Deserialize(
				packageBGenerateResultsMockFile->Content, fileSystemState);
										   ...
										   ValueTable(
											   {
												   {"SoupTargetDirectory",
													std::string(
														"C:/Users/Me/.soup/packages/C++/user1/"
														"package-a/1.2.3/out/HASH1/.soup/")},
											   })},
										  {"user1|package-b",
										   ValueTable(
											   {
		...
		void Execute_PackageLock_OverrideBuildDependency() {
			...
			fileSystem->CreateMockFile(
				Path(
					"C:/Users/Me/.soup/packages/C#/TestBuild/1.3.0/out/HASH2/.soup/"
					"generate-phase1.bgr"),
				std::make_shared<MockFile>(std::move(testBuildGenerateResultContent)));
			...
			Assert::AreEqual(
				std::vector<std::string>({
					...
					"INFO: 2>Checking for existing Generate Phase 1 Result",
					"DIAG: "
					"2>C:/Users/Me/.soup/packages/C#/TestBuild/1.3.0/out/HASH2/.soup/"
					"generate-phase1.bgr",
					"INFO: 2>Phase1 previous graph found",
					"INFO: 2>Checking for existing Evaluate Operation Results",
					"DIAG: "
					...
					"DIAG: 2>Map previous operation graph observed results",
					"INFO: 2>Create Directory: "
					"C:/Users/Me/.soup/packages/C#/TestBuild/1.3.0/out/HASH2/temp/",
					"INFO: 2>Save operation results",
					"INFO: 2>Done!",
					"DIAG: 1>Running Build: [C++]my-package",
					"INFO: 1>Build 'my-package'",
			...
			Assert::AreEqual(
				std::vector<std::string>({
					"TryGetDirectoryFilesLastWriteTime: "
					"C:/Users/Me/.soup/packages/C#/TestBuild/1.3.0/out/HASH2/",
					"TryOpenReadBinary: "
					"C:/Users/Me/.soup/packages/C#/TestBuild/1.3.0/out/HASH2/.soup/"
					"generate-phase1.bgr",
					"TryOpenReadBinary: "
