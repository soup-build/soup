...
namespace Soup::Core::Build::UnitTests {
	...
	public:
		...
		void Load_MissingPackageLock_Throws() {
			...
			Assert::AreEqual(
				std::vector<std::string>({
					...
					"C:/WorkingDirectory/my-package/package-lock.sml",
		...
		void Load_LanguageExtension_Prebuilt_ToolDependency_Prebuilt() {
			...
			auto knownLanguages = std::map<std::string, KnownLanguage>({
				{"C++", KnownLanguage("user1", "cpp")},
				{"C#", KnownLanguage("user1", "csharp")},
			});
			auto locationManager = RecipeBuildLocationManager(knownLanguages);
			auto targetBuildGlobalParameters = ValueTable(
				{
			...
			Assert::AreEqual(
				std::vector<std::string>({
					...
					"DIAG: Load Recipe: "
					"C:/Users/Me/.soup/packages/C++/user1/test-tool/4.4.4/recipe.sml",
					"INFO: Skip loading sub graph for prebuilt package",
				}),
				testListener->GetMessages(),
				"Verify log messages match expected.");
							...
							{2,
							 PackageInfo(
								 ...
								 &recipeCache.GetRecipe(Path(
									 "C:/Users/Me/.soup/packages/Wren/user1/cpp/1.1.1/recipe.sml")),
								 PackageChildrenMap())},
							{3,
							 PackageInfo(
								 3,
								 ...
								 &recipeCache.GetRecipe(Path(
									 "C:/Users/Me/.soup/packages/C++/user1/test-tool/4.4.4/"
									 "recipe.sml")),
								 PackageChildrenMap())},
						}),
					PackageTargetDirectories(
						{
							...
							{2,
							 {
								 {3,
								  "C:/Users/Me/.soup/artifacts/C++/user1/test-tool/4.4.4/"
								  "user1-test-tool-artifact/"},
							 }},
							{3,
							 {
								 {2,
								  "C:/Users/Me/.soup/artifacts/Wren/user1/cpp/1.1.1/"
								  "user1-cpp-artifact/"},
							 }},
						})),
				packageProvider,
		...
		void Load_LanguageExtension_External_ToolDependency_External() {
			...
			Assert::AreEqual(
				std::vector<std::string>({
					...
					"DIAG: Load PackageLock: "
					"C:/Users/Me/.soup/locks/Wren/user1/cpp/4.5.6/package-lock.sml",
					"INFO: Package lock loaded",
					"DIAG: Load Recipe: "
					"C:/Users/Me/.soup/packages/C++/user1/test-tool/3.3.3/recipe.sml",
					"DIAG: Load PackageLock: "
					"C:/Users/Me/.soup/locks/C++/user1/test-tool/3.3.3/package-lock.sml",
					"INFO: Package lock loaded",
					"DIAG: Load Recipe: C:/Users/Me/.soup/packages/Wren/user1/cpp/1.1.1/recipe.sml",
					"INFO: Skip loading sub graph for prebuilt package",
					"DIAG: Load Recipe: "
					"C:/Users/Me/.soup/packages/Wren/user1/wren/2.2.2/recipe.sml",
					"INFO: Skip loading sub graph for prebuilt package",
				}),
				testListener->GetMessages(),
				"Verify log messages match expected.");
					...
					PackageLookupMap(
						{
							...
							{2,
							 PackageInfo(
								 ...
								 &recipeCache.GetRecipe(Path(
									 "C:/Users/Me/.soup/packages/Wren/user1/cpp/4.5.6/recipe.sml")),
								 PackageChildrenMap(
									 {
										 {"Build",
										  {
							...
							{3,
							 PackageInfo(
								 ...
								 &recipeCache.GetRecipe(Path(
									 "C:/Users/Me/.soup/packages/C++/user1/test-tool/3.3.3/"
									 "recipe.sml")),
								 PackageChildrenMap(
									 {
										 {"Build",
							...
							{5,
							 PackageInfo(
								 ...
								 &recipeCache.GetRecipe(Path(
									 "C:/Users/Me/.soup/packages/Wren/user1/wren/2.2.2/"
									 "recipe.sml")),
								 PackageChildrenMap())},
						}),
					PackageTargetDirectories(
						{
							...
							{4,
							 {
								 {5,
								  "C:/Users/Me/.soup/artifacts/Wren/user1/wren/2.2.2/"
								  "user1-wren-artifact/"},
							 }},
							{5,
							 {
		...
		void Load_BuildDependency_External() {
			...
			Assert::AreEqual(
				std::vector<std::string>({
					...
					"DIAG: Load Recipe: C:/WorkingDirectory/my-package/recipe.sml",
					"DIAG: Load Recipe: "
					"C:/Users/Me/.soup/packages/Wren/user1/test-build/3.3.3/recipe.sml",
					"DIAG: Load PackageLock: "
					"C:/Users/Me/.soup/locks/Wren/user1/test-build/3.3.3/package-lock.sml",
					"INFO: Package lock loaded",
					"DIAG: Load Recipe: "
					"C:/Users/Me/.soup/packages/Wren/user1/wren/2.2.2/recipe.sml",
					"INFO: Skip loading sub graph for prebuilt package",
					...
					PackageLookupMap(
						{
							...
							{2,
							 PackageInfo(
								 ...
								 &recipeCache.GetRecipe(Path(
									 "C:/Users/Me/.soup/packages/Wren/user1/test-build/3.3.3/"
									 "recipe.sml")),
								 PackageChildrenMap(
									 {
										 {"Build",
		...
		// [[Fact]]
		// Verifies that an external build dependency with an external tool dependency loads
		// correctly
								 ...
								 PackageChildrenMap(
									 {
										 {"Build",
										  {
											  PackageChildInfo(
												  PackageReference(Path("../test-build/")),
												  true,
												  -1,
												  3),
											  PackageChildInfo(
		...
		// [[Fact]]
		// Verifies an external build dependency is able to load an external runtime dependency with
		// an implicit owner
		void Load_BuildDependency_External_RuntimeDependency_ImplicitOwner() {
			...
			Assert::AreEqual(
				std::vector<std::string>({
					...
					"INFO: Package lock loaded",
					"DIAG: Load Recipe: "
					"C:/Users/Me/.soup/packages/Wren/user1/test-build2/3.3.3/recipe.sml",
					"DIAG: Load Recipe: "
					"C:/Users/Me/.soup/packages/Wren/user1/wren/2.2.2/recipe.sml",
					"INFO: Skip loading sub graph for prebuilt package",
					...
					PackageLookupMap(
						{
							...
							{3,
							 PackageInfo(
								 ...
								 &recipeCache.GetRecipe(Path(
									 "C:/Users/Me/.soup/packages/Wren/user1/test-build2/3.3.3/"
									 "recipe.sml")),
								 PackageChildrenMap(
									 {
										 {"Build",
		...
		// [[Fact]]
		// Verifies an external build dependency is able to load an external build dependency with
		// an implicit owner
		void Load_BuildDependency_External_BuildDependency_ImplicitOwner() {
			...
			Assert::AreEqual(
				std::vector<std::string>({
					...
					"INFO: Package lock loaded",
					"DIAG: Load Recipe: "
					"C:/Users/Me/.soup/packages/Wren/user1/test-build2/4.4.4/recipe.sml",
					"DIAG: Load PackageLock: "
					"C:/Users/Me/.soup/locks/Wren/user1/test-build2/4.4.4/package-lock.sml",
					"INFO: Package lock loaded",
					"DIAG: Load Recipe: "
					"C:/Users/Me/.soup/packages/Wren/user1/wren/2.2.2/recipe.sml",
					"INFO: Skip loading sub graph for prebuilt package",
					...
					PackageLookupMap(
						{
							...
							{3,
							 PackageInfo(
								 ...
								 &recipeCache.GetRecipe(Path(
									 "C:/Users/Me/.soup/packages/Wren/user1/test-build2/4.4.4/"
									 "recipe.sml")),
								 PackageChildrenMap(
									 {
										 {"Build",
		...
		// [[Fact]]
		// Verifies an external build dependency is able to load an external tool dependency with an
		// implicit owner
		...
		void Load_BuildDependency_External_Override() {
			...
			Assert::AreEqual(
				std::vector<std::string>({
					...
					"DIAG: Load Recipe: C:/WorkingDirectory/my-package/recipe.sml",
					"DIAG: Load Recipe: "
					"C:/Users/Me/.soup/packages/Wren/user1/test-build/3.3.4/recipe.sml",
					"DIAG: Load PackageLock: "
					"C:/Users/Me/.soup/locks/Wren/user1/test-build/3.3.4/package-lock.sml",
					"INFO: Package lock loaded",
					"DIAG: Load Recipe: "
					"C:/Users/Me/.soup/packages/Wren/user1/wren/2.2.3/recipe.sml",
					"DIAG: Load PackageLock: "
					"C:/Users/Me/.soup/locks/Wren/user1/wren/2.2.3/package-lock.sml",
					"INFO: Package lock loaded",
					"DIAG: Load Recipe: "
					"C:/Users/Me/.soup/packages/Wren/user1/wren/2.2.2/recipe.sml",
					"INFO: Skip loading sub graph for prebuilt package",
					...
					"DIAG: Load PackageLock: "
					"C:/Users/Me/.soup/locks/Wren/user1/cpp/1.1.2/package-lock.sml",
					"INFO: Package lock loaded",
					"DIAG: Graph already loaded: C:/Users/Me/.soup/packages/Wren/user1/wren/2.2.2/",
				}),
				testListener->GetMessages(),
					...
					PackageLookupMap(
						{
							...
							{2,
							 PackageInfo(
								 ...
								 &recipeCache.GetRecipe(Path(
									 "C:/Users/Me/.soup/packages/Wren/user1/test-build/3.3.4/"
									 "recipe.sml")),
								 PackageChildrenMap(
									 {
										 {"Build",
							...
							{3,
							 PackageInfo(
								 ...
								 &recipeCache.GetRecipe(Path(
									 "C:/Users/Me/.soup/packages/Wren/user1/wren/2.2.3/"
									 "recipe.sml")),
								 PackageChildrenMap(
									 {
										 {"Build",
							...
							{5,
							 PackageInfo(
								 ...
								 &recipeCache.GetRecipe(Path(
									 "C:/Users/Me/.soup/packages/Wren/user1/cpp/1.1.2/recipe.sml")),
								 PackageChildrenMap(
									 {
										 {"Build",
										  {
		...
		void
		Load_RuntimeDependency_Local_ExplicitLanguageOverride_MultipleReferences_ReuseBuildGraph() {
			// Register the test listener
			auto testListener = std::make_shared<TestTraceListener>();
			auto scopedTraceListener = ScopedTraceListenerRegister(testListener);
			...
			Assert::AreEqual(
				std::vector<std::string>({
					...
					"DIAG: Load Recipe: "
					"C:/Users/Me/.soup/packages/Wren/user1/csharp/2.2.3/recipe.sml",
					"DIAG: Load PackageLock: "
					"C:/Users/Me/.soup/locks/Wren/user1/csharp/2.2.3/package-lock.sml",
					"INFO: Package lock loaded",
					"DIAG: Load Recipe: "
					"C:/Users/Me/.soup/packages/Wren/user1/wren/2.2.2/recipe.sml",
					"INFO: Skip loading sub graph for prebuilt package",
					"DIAG: Graph already loaded: "
					"C:/Users/Me/.soup/packages/Wren/user1/csharp/2.2.3/",
				}),
				testListener->GetMessages(),
				"Verify log messages match expected.");
								 ...
								 PackageChildrenMap(
									 {
										 ...
										 {"Runtime",
										  {
											  PackageChildInfo(
												  PackageReference(Path("../package1/")),
												  false,
												  2,
												  -1),
										  }},
		...
		// [[Fact]]
		// Verifies that external runtime dependencies that create a triangle reference resolve
		// correctly to only build each package once
		void Load_RuntimeDependency_External_Triangle_BuildOnce() {
			...
			Assert::AreEqual(
				std::vector<std::string>({
					...
					"DIAG: Load Recipe: C:/WorkingDirectory/my-package/recipe.sml",
					"DIAG: Load Recipe: "
					"C:/Users/Me/.soup/packages/C++/user1/package-a/3.3.3/recipe.sml",
					"DIAG: Load Recipe: "
					"C:/Users/Me/.soup/packages/C++/user1/package-b/4.4.4/recipe.sml",
					"DIAG: Load Recipe: C:/Users/Me/.soup/packages/Wren/user1/cpp/1.1.1/recipe.sml",
					"INFO: Skip loading sub graph for prebuilt package",
					"DIAG: Graph already loaded: C:/Users/Me/.soup/packages/Wren/user1/cpp/1.1.1/",
					...
					PackageLookupMap(
						{
							...
							{2,
							 PackageInfo(
								 ...
								 &recipeCache.GetRecipe(Path(
									 "C:/Users/Me/.soup/packages/C++/user1/package-a/3.3.3/"
									 "recipe.sml")),
								 PackageChildrenMap(
									 {
										 {"Build",
							...
							{3,
							 PackageInfo(
								 ...
								 &recipeCache.GetRecipe(Path(
									 "C:/Users/Me/.soup/packages/C++/user1/package-b/4.4.4/"
									 "recipe.sml")),
								 PackageChildrenMap(
									 {
										 {"Build",
		...
		// [[Fact]]
		// Verifies ability to load a runtime dependency with a name other than "Runtime" with an
		// explicit language
		void Load_OtherDependency_ExplicitLanguage() {
			...
			Assert::AreEqual(
				std::vector<std::string>({
					...
					"DIAG: Load Recipe: C:/WorkingDirectory/my-package/recipe.sml",
					"DIAG: Load Recipe: "
					"C:/Users/Me/.soup/packages/C#/user1/package1/4.4.4/recipe.sml",
					"DIAG: Load Recipe: "
					"C:/Users/Me/.soup/packages/Wren/user1/csharp/3.3.3/recipe.sml",
					"INFO: Skip loading sub graph for prebuilt package",
					"DIAG: Load Recipe: C:/Users/Me/.soup/packages/Wren/user1/cpp/1.1.1/recipe.sml",
					"INFO: Skip loading sub graph for prebuilt package",
				}),
					...
					PackageLookupMap(
						{
							...
							{2,
							 PackageInfo(
								 ...
								 &recipeCache.GetRecipe(Path(
									 "C:/Users/Me/.soup/packages/C#/user1/package1/4.4.4/"
									 "recipe.sml")),
								 PackageChildrenMap(
									 {
										 {"Build",
							...
							{3,
							 PackageInfo(
								 ...
								 &recipeCache.GetRecipe(Path(
									 "C:/Users/Me/.soup/packages/Wren/user1/csharp/3.3.3/"
									 "recipe.sml")),
								 PackageChildrenMap())},
							{4,
							 PackageInfo(
					...
					PackageTargetDirectories(
						{
							...
							{2,
							 {
								 {3,
								  "C:/Users/Me/.soup/artifacts/Wren/user1/csharp/3.3.3/"
								  "user1-soup-csharp-artifact/"},
							 }},
							{3,
							 {
								 {4,
		...
		// [[Fact]]
		// Verifies ability to detect a runtime dependency that uses the parent build package
		// creating a circular dependency that requires a pre-built package to break the circle
		void Load_CircularBuildDependency_Throws() {
			...
			Assert::AreEqual(
				std::vector<std::string>({
					...
					"DIAG: Load Recipe: C:/WorkingDirectory/my-package/recipe.sml",
					"DIAG: Load Recipe: "
					"C:/Users/Me/.soup/packages/Wren/user1/wren/1.1.1/recipe.sml",
					"DIAG: Load PackageLock: "
					"C:/Users/Me/.soup/locks/Wren/user1/wren/1.1.1/package-lock.sml",
					"INFO: Package lock loaded",
					"DIAG: Load Recipe: "
					"C:/Users/Me/.soup/packages/Wren/user1/package1/4.4.4/recipe.sml",
