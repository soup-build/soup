// <copyright file="operation-results.cpp" company="Soup">
...
namespace Soup::Core {
	/// <summary>
	/// The cached operation results that is used to track input/output mappings
	/// for previous build executions to support incremental builds
	/// </summary>
	...
	public:
		...
		/// </summary>
		bool TryFindResult(OperationId operationId, OperationResult *&result) {
