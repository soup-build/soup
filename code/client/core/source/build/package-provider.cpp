...
export namespace Soup::Core {
	...
	public:
		...
		bool operator==(const PackageInfo &rhs) const {
			...
			return Id == rhs.Id && Name == rhs.Name && artifactDigestEqual &&
				   PackageRoot == rhs.PackageRoot && Recipe == rhs.Recipe &&
	...
	public:
		...
		bool operator==(const PackageGraph &rhs) const {
			return Id == rhs.Id && RootPackageId == rhs.RootPackageId &&
	...
	/// <summary>
	/// The package provider that maintains the in memory representation of all
	/// build state
	/// </summary>
