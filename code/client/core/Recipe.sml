...
Source: [
	...
	'source/build/recipe-buildArguments.cpp'
	'source/build/macro-manager.cpp'
	'source/build/package-provider.cpp'
	'source/build/recipe-build-cacheState.cpp'
	'source/build/recipe-buildLocationManager.cpp'
	'source/build/system-accessTracker.cpp'
	'source/local-user-config/localUser-config.cpp'
	'source/local-user-config/localUser-config-extensions.cpp'
	...
	'source/package-lock/package-lockExtensions.cpp'
