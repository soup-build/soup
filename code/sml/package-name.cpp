// <copyright file="package-name.cpp" company="Soup">
...
namespace Soup::SML {
	...
	public:
		...
		/// Initializes a new instance of the <see cref="PackageName"/> class.
		/// </summary>
		PackageName(std::optional<std::string> owner, std::string name)
		...
		bool operator==(const PackageName &rhs) const {
			return _owner == rhs._owner && _name == rhs._name;
		}
