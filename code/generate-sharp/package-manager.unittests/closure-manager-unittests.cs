...
public class ClosureManagerUnitTests
{
	...
	public async Task RestorePackagesAsync_NoDependencies()
	{
		...
		var generateClosureResult = new Api.Client.GenerateClosureResultModel()
		{
			...
			BuildClosures = new Dictionary<string, ICollection<Api.Client.PackageBuildDependencyReferenceModel>>()
			{
				{
					"Build0",
					new List<Api.Client.PackageBuildDependencyReferenceModel>()
					{
			...
			ToolClosures = new Dictionary<string, ICollection<Api.Client.PackageBuildDependencyReferenceModel>>()
			{
				{
					"Tool0",
					new List<Api.Client.PackageBuildDependencyReferenceModel>()
		...
		await uut.GenerateAndRestoreRecursiveLocksAsync(
			...
			new Path("C:/ArtifactStore/"),
			new Path("C:/Staging/"));

		// Verify expected logs
		Assert.Equal(
			[
				"INFO: Ensure Package Lock Exists: C:/Root/my-package/package-lock.sml",
				"DIAG: Load Package Lock: C:/Root/my-package/package-lock.sml",
				...
				"DIAG: Wren my-package -> C:/Root/my-package/",
		...
		Assert.Equal(
			[
				"Exists: C:/Root/my-package/package-lock.sml",
		...
		var packageLock = mockFileSystem.GetMockFile(new Path("C:/Root/my-package/package-lock.sml"));
	...
	public async Task RestorePackagesAsync_HasLocalBuildDependency()
	{
		...
		// Verify the contents of the package lock file
		var packageLock1 = mockFileSystem.GetMockFile(new Path("C:/Root/my-package/package-lock.sml"));
	...
	public async Task RestorePackagesAsync_HasDependencies_HasPackageLock_OneOverride()
	{
		...
		mockFileSystem.CreateMockFile(
			new Path("C:/Root/my-package/package-lock.sml"),
	...
	public async Task RestorePackagesAsync_HasDependencies_HasPackageLock_AllLocal()
	{
		...
		var original =
			...
			Closure: {
				Wren: {
					'my-package': { Version: './', Build: 'BuildSet0' }
